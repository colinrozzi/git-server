...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:component:git-server:default:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 884] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xf6\x05\x01A\x02\x01\
...
er:simple/actor\x05\x04\x04\0\x1ccomponent:git-server/default\x04\0\x0b\x0d\x01\0\
\x07default\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x07\
